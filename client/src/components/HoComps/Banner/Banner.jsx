                ...
                <div className="flex flex-col items-center md:mx-72 justify-center md:flex-row md:space-x-12 lg:space-x-24">
                    <div className="w-full md:w-3/4 content-column flex justify-between align-middle animate-fade-down">
                        ...
                        <div className="flex flex-col   p-10">
                            ...
                            <h2 className="text-3xl md:text-5xl font-extrabold mt-2 mb-2">Track Your Cart</h2>
                            <p className="text-sm md:text-base mt-2">Compre with all platform and get at discounted price</p>
                            <div className="mt-6">
                    ...
                    <div className="w-full md:w-1/2 image-column animate-fade-down ">
