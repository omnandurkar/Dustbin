            ...
            <div className="mt-6">
                <form 
                    ...
                    <input 
                        ...
                        className="text-gray-500 w-full p-3 rounded-md border outline-none focus:border-green-600"
                    />
                    <button
                        className="w-full mt-3 px-5 py-3 rounded-md text-white bg-green-600 hover:bg-green-500 active:bg-green-700 duration-150 outline-none shadow-md focus:shadow-none focus:ring-2 ring-offset-2 ring-green-600 sm:mt-0 sm:ml-3 sm:w-auto"
                    >
                        Subscribe
                    </button>
                </form>
