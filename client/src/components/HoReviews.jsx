    ...
    const testimonials = [
        {
            ...
            quote: "Amazing Concept and art work!!!"
        },
        {
            ...
            quote: "Outstanding concept and art work"
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Avinash Gambhire",
            title: "Product designer",
            quote: "Perfect design, good quality product"
        },
    ]

    return (
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8" data-aos="fade-down" data-aos-delay="300">
                    ...
                    <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl border shadow-md hover:animate-wiggle hover:animate-infinite" data-aos="fade-up" data-aos-delay={`${500 + idx * 300}`}>
                                    <div className="p-4">
                                    ...
                                    <figure>
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-green-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-green-500" />
                                            <div>
