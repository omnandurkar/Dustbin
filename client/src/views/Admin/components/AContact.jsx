...
export default function AContact() {
    ...
    const loadContactUsDetails = async () => {
        try {
            ...
            const sortedData = response.data.data.reverse(); // Reverse the array to get the newest first
    ...
    return (
        <div className='flex space-x-4 justify-center'>
            ...
            <div className='container output border p-5 rounded-md border-green-600'>
                    ...
                    <div className="modal-dialog modal-dialog-centered modal-lg w-full">
                        <div className="modal-content space-y-6">
                            ...
                            <div className="modal-footer space-x-5 mt-2">
                                <button type="button" className="border p-2 rounded-md bg-green-600 hover:bg-green-500 text-white" onClick={() => resolveIssue(contact.indexOf(selectedContact))}>Resolve Issue</button>
                        ...
                        <button type='button' className='border p-2 shadow my-10 rounded-md bg-green-600 hover:bg-green-500 text-white ' onClick={loadContactUsDetails}  > Fetch Contact Reqests</button>
                        </div>
                    </div>
                </div>
            </div>
