                ...
                <section className="text-gray-600 body-font overflow-hidden">
                    <div className="container px-5 pt-10 pb-24 mx-auto">
                        ...
                        <div className="flex flex-wrap -m-4">
                            <div className="p-4 xl:w-1/4 md:w-1/2 w-full animate-fade-up ">
                            ...
                            <div className="p-4 xl:w-1/4 md:w-1/2 w-full animate-fade-up animate-delay-300">
                            ...
                            <div className="p-4 xl:w-1/4 md:w-1/2 w-full animate-fade-up animate-delay-500">
                                <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                            ...
                            <div className="p-4 xl:w-1/4 md:w-1/2 w-full animate-fade-up animate-delay-1000">
                                <div className="h-full p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
